...
export default function YouWon(){
        const r = useRouter();
        return(
                <ImgBackground background = "/Win_Sumatran-01.svg">
                        <Box as={motion.div} 
                initial ={{y:-300}} 
                animate = {{y:-50}} 
                transiton={{type: "spring", stiffness: 700, damping: 60}} width = "75%">
                        ...
                        <Desc padding ="1em">By answering all 10 questions correct, you grew the tallest tree in the Sumatran Rainforest at 435 ft tall.</Desc>
