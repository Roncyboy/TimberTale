...
<FSBackground>
    <BackButton></BackButton>
     ...
     <RowWrapper>
         ...
         height={500}
         width={400}/>
         <Desc style={{marginLeft:"2em", textAlign: "left"}} color="#FFFFFF"> If you get the question wrong the lumberjack will grab an axe and swing at your tree. Dont get 3 wrong or your tree will fall over.</Desc>
     </RowWrapper>
     </Wrapper>
<LongButton size="1em" style={{marginTop:"2em"}} onClick={()=>r.push("/Sumatran")}>Start the Quiz</LongButton>
</FSBackground>
    )
}